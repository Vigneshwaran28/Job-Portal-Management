...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'email', 'password1', 'password2', 'gender','date_of_birth','name','phone','education','profile_picture']
        # fields = '__all__'
...
class EmployeeProfileUpdateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        exclude = ['last_login', 'is_superuser', 'groups', 'user_permissions', 'is_staff', 'is_active', 'date_joined','password',]